...
class FeatureExtractionAgent:
    ...
    def _proposal_payload(self, project: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "recipient_solana_address": project.get("recipient_solana_address"),
            "recipient_evm_address": project.get("recipient_evm_address"),
            "preferred_payout_chain": self._enum_value(project.get("preferred_payout_chain")),
